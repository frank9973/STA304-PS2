...
## Data
Based on our focus, we choose the dataset from the General social survey on Family (cycle 31), 2017. These data are provided by Statistics Canada under the terms of the Data Liberation Initiative (DLI) license. The survey involved 20602 respondents in total and recorded 81 variables of various aspects, including the family background, immigration history, marital status, child rearing, living arrangement, occupation, working condition and family income, health situation, and life satisfaction. In order to analyze the effect of personal life situation on the life satisfaction
score, we select the variables below:
